...
const STAT_CONFIG = [
    { id: 1, label: "생성된 질문", key: "questionCount", img: QUESTION_STAT, unit: "건" },
    { id: 2, label: "이용자 수", key: "userCount", img: USERS_STAT, unit: "명" },
    { id: 3, label: "누적 면접 연습", key: "practiceCount", img: PRACTICE_STAT, unit: "건" },
  ];
            ...
            <S.HookingCardWrapper>
                <S.HookingCardStatBox>
                    ...
                    <S.HookingCardStat key={item.id}>
                        ...
                        <S.HookingCardStatTextMain>{item.label}</S.HookingCardStatTextMain>
