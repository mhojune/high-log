...
export default function PracticeStep2() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { id: 1, sender: 'AI', text: "동아리 활동 중 가장 기억에 남는 프로젝트를 하나 골라 설명해 주세요." },
        { id: 2, sender: 'User', text: "저는 학교 동아리에서 소규모 팀 프로젝트를 진행했고, 저는 자료 조사와 발표 구조 설계를 맡았습니다." },
        { id: 3, sender: 'AI', text: "그 프로젝트에서 가장 어려웠던 점은 무엇이었나요?" },
        { id: 4, sender: 'User', text: "팀원 간의 의견 조율이 가장 힘들었습니다. 서로 다른 주제를 원했거든요." },
        { id: 5, sender: 'AI', text: "그 갈등을 어떻게 해결하셨나요?" },
        { id: 6, sender: 'User', text: "팀원 간의 의견 조율이 가장 힘들었습니다. 서로 다른 주제를 원했거든요." },
    ]);
            ...
            <S.PracticeStep2Container>
                <S.PracticeWrapper>
                    <S.TimerResetBox>
                        ...
                        <DefaultButton width={78} type="secondary" text="리셋" onClick={handleReset} />
                    </S.TimerResetBox>
                    <S.ChattingWrapper>
                        {messages.map((msg) => (
                            msg.sender === 'AI' ? (
